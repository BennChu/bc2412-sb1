...
public class HelloworldController {
  ...
  public Integer[] getIntegers() {
    return new Integer[] {3, 100, 2};//[3,100,2]
  }

  // Create another API to return List of String
  @GetMapping(value = "/strings")
  public List<String> getStrings() {
    return Arrays.asList("vincent", "lucas");//["vincent","lucas"]
  }

  // Create another API to return a Cat
  @GetMapping(value = "/cat")
  public Cat getCat() {
    return new Cat("John", 3);//{"name":"John","age":3} 用左 lombok getter
  }
  ...
  public List<Cat> getCats() {
    ...
    //[{"name":"John","age":3},{"name":"Sally","age":4}]
  }
